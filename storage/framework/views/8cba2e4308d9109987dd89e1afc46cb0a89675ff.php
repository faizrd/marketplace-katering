...
<body>
    <section class="content" style="margin-top: 10%">
        <div class="error-content text-center" style="margin: 0">
            ...
            <p>
                Silahkan <a href="<?php echo e(url('/login')); ?>"onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><strong>Login</strong></a> sebagai customer, atau <a href="<?php echo e(url('/admin')); ?>"><strong>kembali ke halaman Dashboard</strong>.</a>
            </p>
