            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo e(url('/home')); ?>">
                        <strong><?php echo e(config('Marketplace Katering', 'Marketplace Katering')); ?></strong>
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php else: ?>
                            <li>
                                <a href="<?php echo e(route('listOrder')); ?>">
                                    <i class="fa fa-shopping-basket" aria-hidden="true" style="margin-right: 5px"></i> <strong>Pesanan</strong>
                                </a>
                            </li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                    <i class="fa fa-user" aria-hidden="true" style="margin-right: 5px"></i> <strong><?php echo e(explode(" ", Auth::user()->name)[0]); ?></strong> 
                                    <span class="caret"></span>
                                </a>

                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="<?php echo e(url('/profile')); ?>">Lihat Profil</a>
