...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/dashboard/plugins/iCheck/square/blue.css')); ?>">
...
<body class="hold-transition login-page">
    ...
    <!-- iCheck -->
    <script src="<?php echo e(asset('assets/dashboard/plugins/iCheck/icheck.min.js')); ?>"></script>
    <script>
        $(function () {
            $('input').iCheck({
